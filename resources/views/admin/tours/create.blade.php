                ...
                <div class="collapse show" id="collapseTourInfo">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" class="form-control" name="name" value="{{ old('name') }}" placeholder="Nhập tên tour" required>
                        </div>
                        <div class="mb-3">
                            <label for="price" class="form-label">Giá tour</label>
                            <input type="number" id="price" class="form-control" name="price" value="{{ old('price') }}" placeholder="Nhập giá tour" required>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">Mô tả tour</label>
                            <textarea name="description" id="ckeditor-classic" class="form-control" placeholder="Nhập mô tả tour">{{ old('description') }}</textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="extra-features-list">
                                    <div class="row mb-2 extra-feature">
                                        <div class="col-md-6">
                                            <input type="text" name="extra_features[0][name]" class="form-control" placeholder="Tên tính năng">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="number" name="extra_features[0][price]" class="form-control" placeholder="Giá thêm">
                                        </div>
                                    </div>
                                </div>
